...
} from '@/contexts/DocumentContexts';
...
// Reports module (home tile /reports)
import ReportsModuleLayout from '@/pages/reports/ReportsModuleLayout';
import ReportsExcelHubPage from '@/pages/reports/ReportsExcelHubPage';
import SalesExcelExtraction from '@/pages/sales/reports/SalesExcelExtraction';
import CollectionsExcelExtraction from '@/pages/sales/reports/CollectionsExcelExtraction';
import CollectedExcelExtraction from '@/pages/sales/reports/CollectedExcelExtraction';
import ReimbursementsExcelExtraction from '@/pages/sales/reports/ReimbursementsExcelExtraction';
import ShareProfitExcelExtraction from '@/pages/sales/reports/ShareProfitExcelExtraction';
                                                ...
                                                <ExpensesProvider>
                                                    ...
                                                    <AppLayout>
                                                        <Routes>
                                                            ...
                                                            <Route
                                                                path='/account-settings/staff-restrictions'
                                                                element={
                                                                    <ProtectedRoute requiredRole='OWNER'>
                                                                        <StaffRestrictionsPage />
                                                                    </ProtectedRoute>
                                                                }
                                                            />
                                                            <Route
                                                                path='/account-settings/staff-restrictions/:staffId'
                                                                element={
                                                                    <ProtectedRoute requiredRole='OWNER'>
                                                                        <StaffDetailPage />
                                                                    </ProtectedRoute>
                                                            ...
                                                            >
                                                                ...
                                                                />
                                                                <Route
                                                                    path='projects/:projectId/full-preview'
                                                                    element={
                                                                        <ProtectedPageRoute
                                                                            module='sales'
                                                                            page='project_lists'
                                                            ...
                                                            >
                                                                ...
                                                                <Route
                                                                    path='data-entry/regular-expenses'
                                                                    element={
                                                                        <ProtectedPageRoute
                                                                            module='expenses'
                                                                            page='data_entry'
                                                                ...
                                                                />
                                                                <Route
                                                                    path='data-entry/capitalisation'
                                                                    element={
                                                                        <ProtectedPageRoute
                                                                            module='expenses'
                                                                            page='data_entry'
                                                            ...
                                                            >
                                                                ...
                                                                <Route
                                                                    path='sales'
                                                                    element={
                                                                        <SalesExcelExtraction />
                                                                    }
                                                                />
                                                                <Route
                                                                    path='collections'
                                                                    element={
                                                                        <CollectionsExcelExtraction />
                                                                    }
                                                                />
                                                                <Route
                                                                    path='collected'
                                                                    element={
                                                                        <CollectedExcelExtraction />
                                                                    }
                                                                />
                                                                <Route
                                                                    path='reimbursements'
                                                                    element={
                                                                        <ReimbursementsExcelExtraction />
                                                                    }
                                                                />
                                                                <Route
                                                                    path='share-profit'
                                                                    element={
                                                                        <ShareProfitExcelExtraction />
                                                                    }
                                                                />
                                                            </Route>
