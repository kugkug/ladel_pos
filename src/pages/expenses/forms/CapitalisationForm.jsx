...
const PEOPLE = ['Rome', 'Alex', 'CBC', 'SB', 'LBP'];
...
const CapitalisationForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!formData.bank_funded)
                throw new Error('Bank Funded is required');
            ...
            <div className='flex items-center gap-4 mb-6'>
                ...
                <div>
                    <h1 className='text-2xl font-bold text-blue-600'>
                        Capitalisation / Funding Entry
                    </h1>
                    <p className='text-sm text-gray-500'>
                        Record capital injections or funding into the company
                    </p>
                </div>
            </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder='0.00'
                            className='w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-bold text-blue-600'
                        />
                    </div>
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            placeholder='Details about this funding...'
                            className='w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none'
                        ></textarea>
                    </div>
                </div>
